...
class AliyunRunInstancesExample(object):
    ...
    def __init__(self):
        ...
        # 实例的资源规格
        self.instance_type = 'ecs.t5-lc1m1.small'
        # 实例的计费方式
        self.instance_charge_type = 'PostPaid'
        # 镜像ID
        self.image_id = 'ubuntu_20_04_x64_20G_alibase_20200522.vhd'
        # 购买资源的时长
        self.period = 1
        # 购买资源的时长单位
        ...
        # 实例名称
        self.instance_name = 'huabei01-20200714'
        # 实例的描述
        self.description = '华北服务器01'
        # 指定创建ECS实例的数量
        self.amount = 1
        # 公网出带宽最大值
        self.internet_max_bandwidth_out = 5
        # 云服务器的主机名
        self.host_name = 'huabei01'
        # 是否为I/O优化实例
